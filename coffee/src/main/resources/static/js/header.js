window.kakao = window.kakao || {},
	...
	function() {
		...
		if (void 0 === t.readyState)
			t.onloadcallbacks = [],
				t.readyState = 0;
		else if (2 === t.readyState)
			return;
		t.URI_FUNC = {
			ROADMAP: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNGSD01/v16_260kk/" + e + "/" + n + "/" + a + ".png"
			},
			HYBRID: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNGSD_SKYH01/v15_u50gu/" + e + "/" + n + "/" + a + ".png"
			},
			ROADVIEW: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNGSD_RV01/v08_faetr/" + e + "/" + n + "/" + a + ".png"
			},
			BICYCLE: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNGSD_BIKE01/v06_aroce/" + e + "/" + n + "/" + a + ".png"
			},
			USE_DISTRICT: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNGSD_CAD01/v08_aay0m/" + e + "/" + n + "/" + a + ".png"
			},
			SR: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNGSD_SR01/v21_xe5y9/" + e + "/" + n + "/" + a + ".png"
			},
			BBOUND: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNGSD_BBOUND01/v05_moskd/" + e + "/" + n + "/" + a + ".png"
			},
			HBOUND: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNGSD_HBOUND01/v05_1knbb/" + e + "/" + n + "/" + a + ".png"
			},
			TRAFFIC: function(a, n, e) {
				return "r.maps.daum-img.net/mapserver/file/realtimeroad/L" + e + "/" + n + "/" + a + ".png"
			},
			ROADMAP_HD: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNG01/v22_galhg/" + e + "/" + n + "/" + a + ".png"
			},
			HYBRID_HD: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNG_SKYH01/v14_jvqgx/" + e + "/" + n + "/" + a + ".png"
			},
			ROADVIEW_HD: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNG_RV01/v08_4blvx/" + e + "/" + n + "/" + a + ".png"
			},
			BICYCLE_HD: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNG_BIKE01/v06_xfzbg/" + e + "/" + n + "/" + a + ".png"
			},
			USE_DISTRICT_HD: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNG_CAD01/v11_vvqth/" + e + "/" + n + "/" + a + ".png"
			},
			SR_HD: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNGSD_SR01/v21_xe5y9/" + e + "/" + n + "/" + a + ".png"
			},
			BBOUND_HD: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNG_BBOUND01/v05_jfv03/" + e + "/" + n + "/" + a + ".png"
			},
			HBOUND_HD: function(a, n, e) {
				return "map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNG_HBOUND01/v05_ams0y/" + e + "/" + n + "/" + a + ".png"
			},
			...
			t.RESOURCE_PATH = {
				...
				ROADVIEW_CSS: "//t1.daumcdn.net/roadviewjscore/core/openapi/standard/230727/roadview.js"
			};
